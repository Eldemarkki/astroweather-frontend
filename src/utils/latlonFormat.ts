...
export const latlonToDms = (latlon: LatitudeLongitude) => `${formatDegree(latlon.latitude)} ${latlon.latitude < 0 ? "S" : "N"} ${formatDegree(latlon.longitude)} ${latlon.longitude < 0 ? "W" : "E"}`;
